...
final class NewsNamespace extends PlatformNamespace
{
    public function __construct(HttpClient $http)
    {
        parent::__construct($http, '/news/stocks/v1');
    }

    /**
     * @param array{
     *   from?: string, to?: string, days?: int, limit?: int, offset?: int, type?: string, source?: string
     * } $options
    ...
    /**
     * @param array{from?: string, to?: string, days?: int, limit?: int, offset?: int, source?: string} $options
     * @return array<string, mixed>|list<mixed>
     */
     ...
     * @return array<string, mixed>|list<mixed>
     */
    public function explain(string $ticker): array
    {
        return $this->get('/stock/' . rawurlencode($ticker) . '/explain');
    }
